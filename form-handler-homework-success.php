...
if(isset($_POST["button"])) {
    ...
    if(!isset($_POST["findH"]) || $_POST["findH"] == false) {
        
        //processing form data entered by storing in PHP variables  
        //using trim function to remove any white space form text enterd data  
...
}// entering block for form-handler-homework.php data submitted is false
else {
    header("Location: form-handler-homework.php");
